...
class Station(Producer):
    ...
    # Define the value schema in `schemas/arrival_value.json`
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        topic_name = f"org.chicago.cta.station.arrivals.{station_name}" # create topic name
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        logger.info("Try to produce arrival message to kafka.")
