...
class Weather(Producer):
    ...
    def __init__(self, month):
        ...
        super().__init__(
            topic_name = "org.chicago.cta.weather.v1", # create topic name topic name, matching topic_name in consumer.py
        ...
        # Define the value schema in `schemas/weather_value.json
    ...
    def run(self, month):
        ...
        logger.info("building weather kafka proxy integration")
        resp = requests.post(
