...
class Line:
    ...
    def process_message(self, message):
        ...
        if message.topic.lower()=="org.chicago.cta.stations.table.v1": 
            try:
        ...
        elif "org.chicago.cta.station.arrivals." in message.topic.lower(): 
            self._handle_arrival(message)

        # Set the conditional to the KSQL Turnstile Summary Topic
        elif message.topic.lower() == "turnstile_summary": 
